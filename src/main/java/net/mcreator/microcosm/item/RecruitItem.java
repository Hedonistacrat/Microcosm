...
public class RecruitItem extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:recruit")
	public static final Item block = null;
	public RecruitItem(MicrocosmModElements instance) {
		super(instance, 185);
	}
