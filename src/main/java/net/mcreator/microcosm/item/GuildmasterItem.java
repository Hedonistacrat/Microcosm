...
public class GuildmasterItem extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:guildmaster")
	public static final Item block = null;
	public GuildmasterItem(MicrocosmModElements instance) {
		super(instance, 183);
	}
