...
package net.mcreator.microcosm.particle;
...
public class ParticleStoneSwordParticle {
	...
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("particle_stone_sword"));
	}
