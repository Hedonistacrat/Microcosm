...
import net.mcreator.microcosm.procedures.PlotBlockOnBlockRightClickedProcedure;
...
public class LeafyPlotBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:leafy_plot")
	public static final Block block = null;
	public LeafyPlotBlock(MicrocosmModElements instance) {
		super(instance, 198);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				PlotBlockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
