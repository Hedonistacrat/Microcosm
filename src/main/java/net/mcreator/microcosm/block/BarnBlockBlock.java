...
public class BarnBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:barn_block")
	public static final Block block = null;
	public BarnBlockBlock(MicrocosmModElements instance) {
		super(instance, 101);
	}
