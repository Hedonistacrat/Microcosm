...
public class PlotBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:plot_block")
	public static final Block block = null;
	public PlotBlockBlock(MicrocosmModElements instance) {
		super(instance, 24);
	}
