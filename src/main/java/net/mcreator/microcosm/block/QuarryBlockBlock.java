...
import net.mcreator.microcosm.procedures.QuarryBlockUpdateTickProcedure;
...
import net.mcreator.microcosm.gui.QuarryGUIGui;
...
public class QuarryBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:quarry_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:quarry_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public QuarryBlockBlock(MicrocosmModElements instance) {
		super(instance, 16);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("quarry_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				QuarryBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new QuarryGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("quarry_block");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new QuarryGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
