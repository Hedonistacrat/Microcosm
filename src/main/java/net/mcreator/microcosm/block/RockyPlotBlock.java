...
public class RockyPlotBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:rocky_plot")
	public static final Block block = null;
	public RockyPlotBlock(MicrocosmModElements instance) {
		super(instance, 197);
	}
