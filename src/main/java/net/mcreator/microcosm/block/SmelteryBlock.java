...
import net.mcreator.microcosm.procedures.SmelteryUpdateTickProcedure;
...
import net.mcreator.microcosm.gui.SmelterGUIGui;
...
public class SmelteryBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:smeltery")
	public static final Block block = null;
	@ObjectHolder("microcosm:smeltery")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SmelteryBlock(MicrocosmModElements instance) {
		super(instance, 121);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SmelteryUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 20);
		}
