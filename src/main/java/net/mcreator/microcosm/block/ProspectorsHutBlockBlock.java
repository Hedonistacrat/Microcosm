...
import net.mcreator.microcosm.procedures.ProspectorsHutBlockUpdateTickProcedure;
...
import net.mcreator.microcosm.gui.ProspectorsHutGUIGui;
...
public class ProspectorsHutBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:prospectors_hut_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:prospectors_hut_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ProspectorsHutBlockBlock(MicrocosmModElements instance) {
		super(instance, 35);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("prospectors_hut_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("prospectors_hut_block");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProspectorsHutBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Prospector's Hut");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new ProspectorsHutGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("prospectors_hut_block");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new ProspectorsHutGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
