...
public class WaterslabBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:waterslab")
	public static final Block block = null;
	public WaterslabBlock(MicrocosmModElements instance) {
		super(instance, 39);
