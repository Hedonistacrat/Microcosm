...
import net.mcreator.microcosm.procedures.FieldUpdateTickProcedure;
...
public class GrowingFieldBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:growing_field_block")
	public static final Block block = null;
	public GrowingFieldBlockBlock(MicrocosmModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("growing_field_block");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				FieldUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
