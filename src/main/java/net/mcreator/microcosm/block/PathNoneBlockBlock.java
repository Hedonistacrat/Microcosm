...
public class PathNoneBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:path_none_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:path_none_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PathNoneBlockBlock(MicrocosmModElements instance) {
		super(instance, 3);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("path_none_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("path_none_block");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("path_none_block");
		}
