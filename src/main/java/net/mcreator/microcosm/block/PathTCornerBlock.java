...
public class PathTCornerBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:path_t_corner")
	public static final Block block = null;
	@ObjectHolder("microcosm:path_t_corner")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PathTCornerBlock(MicrocosmModElements instance) {
		super(instance, 8);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("path_t_corner"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("path_t_corner");
		}
