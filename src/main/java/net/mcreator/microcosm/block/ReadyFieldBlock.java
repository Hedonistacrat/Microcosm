...
public class ReadyFieldBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:ready_field")
	public static final Block block = null;
	public ReadyFieldBlock(MicrocosmModElements instance) {
		super(instance, 79);
	}
