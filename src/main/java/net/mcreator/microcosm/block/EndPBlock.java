...
import net.mcreator.microcosm.gui.EndPGuiGui;
...
public class EndPBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:end_p")
	public static final Block block = null;
	@ObjectHolder("microcosm:end_p")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public EndPBlock(MicrocosmModElements instance) {
		super(instance, 176);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("end_p"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("End Portal");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new EndPGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("end_p");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new EndPGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
