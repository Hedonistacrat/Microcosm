...
import net.mcreator.microcosm.procedures.KilnBlockUpdateTickProcedure;
import net.mcreator.microcosm.itemgroup.MicrocosmItemGroup;
import net.mcreator.microcosm.gui.KilnGuiGui;
...
public class KilnBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:kiln_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:kiln_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public KilnBlockBlock(MicrocosmModElements instance) {
		super(instance, 22);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("kiln_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				KilnBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Kiln");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new KilnGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("kiln_block");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new KilnGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
