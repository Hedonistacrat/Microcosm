...
import net.mcreator.microcosm.procedures.PathUpdateProcProcedure;
import net.mcreator.microcosm.procedures.PathPlaceTickProcedure;
...
public class PathEndBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:path_end_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:path_end_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PathEndBlockBlock(MicrocosmModElements instance) {
		super(instance, 5);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("path_end_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("path_end_block");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PathNoneBlockBlock.block));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				PathUpdateProcProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PathPlaceTickProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("path_end_block");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Path End");
		}
		...
		private final FluidTank fluidTank = new FluidTank(10) {
			@Override
