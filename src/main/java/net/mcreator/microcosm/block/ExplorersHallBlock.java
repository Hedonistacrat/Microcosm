...
import net.mcreator.microcosm.gui.ExplorersHallGUIGui;
...
public class ExplorersHallBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:explorers_hall")
	public static final Block block = null;
	@ObjectHolder("microcosm:explorers_hall")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ExplorersHallBlock(MicrocosmModElements instance) {
		super(instance, 146);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("explorers_hall"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("explorers_hall");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Explorers Hall");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new ExplorersHallGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("explorers_hall");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new ExplorersHallGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
