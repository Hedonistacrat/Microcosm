...
public class PathXCornerBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:path_x_corner")
	public static final Block block = null;
	@ObjectHolder("microcosm:path_x_corner")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PathXCornerBlock(MicrocosmModElements instance) {
		super(instance, 9);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("path_x_corner"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("path_x_corner");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Path X");
		}
