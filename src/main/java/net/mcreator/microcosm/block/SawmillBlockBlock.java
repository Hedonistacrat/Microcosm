...
import net.mcreator.microcosm.procedures.SawmillBlockUpdateTickProcedure;
...
import net.mcreator.microcosm.gui.SawmillGuiGui;
...
public class SawmillBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:sawmill_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:sawmill_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SawmillBlockBlock(MicrocosmModElements instance) {
		super(instance, 20);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sawmill_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sawmill_block");
		}
