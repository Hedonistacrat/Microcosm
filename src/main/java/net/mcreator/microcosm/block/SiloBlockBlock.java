...
import net.mcreator.microcosm.procedures.SiloBlockUpdateTickProcedure;
...
import net.mcreator.microcosm.gui.SiloGuiGui;
...
public class SiloBlockBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:silo_block")
	public static final Block block = null;
	@ObjectHolder("microcosm:silo_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SiloBlockBlock(MicrocosmModElements instance) {
		super(instance, 102);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("silo_block"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SiloBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 20);
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Silo");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SiloGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("silo_block");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new SiloGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
