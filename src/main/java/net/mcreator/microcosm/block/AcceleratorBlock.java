...
import net.mcreator.microcosm.procedures.AcceleratorUpdateTickProcedure;
...
public class AcceleratorBlock extends MicrocosmModElements.ModElement {
	@ObjectHolder("microcosm:accelerator")
	public static final Block block = null;
	public AcceleratorBlock(MicrocosmModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				AcceleratorUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
