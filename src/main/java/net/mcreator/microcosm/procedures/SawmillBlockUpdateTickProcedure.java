...
import net.mcreator.microcosm.particle.ParticleStoneAxeParticle;
...
public class SawmillBlockUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		ItemStack LogType = ItemStack.EMPTY;
		double chance = 0;
		double ScanRadius = 0;
		double ScanX = 0;
		double ScanZ = 0;
		double XPBase = 0;
		chance = (double) (120 / ((new Object() {
			...
			for (int index1 = 0; index1 < (int) ((1 + (ScanRadius * 2))); index1++) {
				if ((((world.getBlockState(new BlockPos((int) (x + ScanX), (int) y, (int) (z + ScanZ)))).getBlock() == GroveBlockBlock.block)
					...
					if (!world.isRemote()) {
						...
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("Logs", ((new Object() {
								public double getValue(IWorld world, BlockPos pos, String tag) {
									TileEntity tileEntity = world.getTileEntity(pos);
									if (tileEntity != null)
										return tileEntity.getTileData().getDouble(tag);
							...
							}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "Logs")) + (((new Random()).nextInt((int) (new Object() {
								public double getValue(IWorld world, BlockPos pos, String tag) {
									TileEntity tileEntity = world.getTileEntity(pos);
									if (tileEntity != null)
										return tileEntity.getTileData().getDouble(tag);
							...
							}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "Level")) + 1)) + 1)));
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
					if (!world.isRemote()) {
		...
		if ((((new Object() {
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "Logs")) > 0))) {
			if (!world.isRemote()) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					...
					}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "Logs")) - 1));
				if (world instanceof World)
					((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = (LogType);
			...
			if (world instanceof ServerWorld) {
				((ServerWorld) world).spawnParticle(ParticleStoneAxeParticle.particle, (x + 0.5), (y + 0.75), (z + 0.5), (int) 1, 0.12, 0.12, 0.12,
						0);
			}
		}
	}
