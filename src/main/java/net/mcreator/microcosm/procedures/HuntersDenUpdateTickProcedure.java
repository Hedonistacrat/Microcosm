...
import net.mcreator.microcosm.particle.ParticleBowParticle;
...
public class HuntersDenUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				MicrocosmMod.LOGGER.warn("Failed to load dependency x for procedure HuntersDenUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				MicrocosmMod.LOGGER.warn("Failed to load dependency y for procedure HuntersDenUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				MicrocosmMod.LOGGER.warn("Failed to load dependency z for procedure HuntersDenUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				MicrocosmMod.LOGGER.warn("Failed to load dependency world for procedure HuntersDenUpdateTick!");
			return;
		}
		...
		XPBase = (double) 64;
		Destination = (String) "Gone Huntin'";
		if ((((new Object() {
			...
			Destination = (String) "Gone Fishin'";
		}
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
			...
			Destination = (String) "Send the Slayers";
		}
		if ((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
		...
		for (int index0 = 0; index0 < (int) (((new Object() {
			...
			roll = (double) (((new Random()).nextInt((int) 1100 + 1)) + (new Object() {
				public double getValue(IWorld world, BlockPos pos, String tag) {
					TileEntity tileEntity = world.getTileEntity(pos);
					if (tileEntity != null)
						return tileEntity.getTileData().getDouble(tag);
			...
			if ((roll < 1000)) {
				if (((Destination).equals("Gone Fishin'"))) {
					...
					}.getRandomItem(("microcosm:ocean_hunter").toLowerCase(java.util.Locale.ENGLISH))));
				} else {
					Loot = new ItemStack((new Object() {
						public Item getRandomItem(String _tagName) {
							ITag<Item> _tag = ItemTags.getCollection().getTagByID(new ResourceLocation(_tagName));
					...
					}.getRandomItem(("microcosm:overworld_hunter").toLowerCase(java.util.Locale.ENGLISH))));
				}
			} else {
				if (((Destination).equals("Gone Fishin'"))) {
					Loot = new ItemStack((new Object() {
					...
					}.getRandomItem(("microcosm:ocean_hunter_rare").toLowerCase(java.util.Locale.ENGLISH))));
				} else {
					Loot = new ItemStack((new Object() {
						public Item getRandomItem(String _tagName) {
							ITag<Item> _tag = ItemTags.getCollection().getTagByID(new ResourceLocation(_tagName));
					...
					}.getRandomItem(("microcosm:overworld_hunter_rare").toLowerCase(java.util.Locale.ENGLISH))));
				}
			}
			InvLoop = (double) 0;
			maxstack = (double) 64;
		...
		if (world instanceof ServerWorld) {
			((ServerWorld) world).spawnParticle(ParticleBowParticle.particle, (x + 0.5), (y + 0.75), (z + 0.5), (int) 0, 0.12, 0.12, 0.12, 0);
		}
		if (world instanceof World && !world.isRemote()) {
			((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
					(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.skeleton.shoot")),
