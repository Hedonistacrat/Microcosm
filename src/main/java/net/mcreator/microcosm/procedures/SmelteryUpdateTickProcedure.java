...
public class SmelteryUpdateTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((Vault).getOrCreateTag().getBoolean("Vault"))) {
			...
			if (((world.getBlockState(new BlockPos((int) VX, (int) VY, (int) VZ))).getBlock() == VaultBlock.block)) {
				if (((new Object() {
					...
					if (!world.isRemote()) {
						...
						if (_tileEntity != null)
							...
							}.getValue(world, new BlockPos((int) VX, (int) VY, (int) VZ), "Iron")) + 1));
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
					{
				...
				}.getAmount(world, new BlockPos((int) x, (int) y, (int) z), (int) (1))) >= 9)) {
					if (!world.isRemote()) {
						BlockPos _bp = new BlockPos((int) VX, (int) VY, (int) VZ);
						TileEntity _tileEntity = world.getTileEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putDouble("Gold", ((new Object() {
								public double getValue(IWorld world, BlockPos pos, String tag) {
									TileEntity tileEntity = world.getTileEntity(pos);
									if (tileEntity != null)
										return tileEntity.getTileData().getDouble(tag);
							...
							}.getValue(world, new BlockPos((int) VX, (int) VY, (int) VZ), "Gold")) + 1));
						if (world instanceof World)
							((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
					{
