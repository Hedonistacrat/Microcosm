...
public class MineshaftGUIGuiWindow extends ContainerScreen<MineshaftGUIGui.GuiContainerMod> {
	...
	private final static HashMap guistate = MineshaftGUIGui.guistate;
	public MineshaftGUIGuiWindow(MineshaftGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Mine Shaft level: " + ((int) new Object() {
