...
@OnlyIn(Dist.CLIENT)
public class SiloGuiGuiWindow extends ContainerScreen<SiloGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = SiloGuiGui.guistate;
	public SiloGuiGuiWindow(SiloGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("microcosm:textures/silo_gui.png");
	@Override
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Wheat " + ((int) new Object() {
